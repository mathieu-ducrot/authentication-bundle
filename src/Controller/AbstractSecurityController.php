...
use Smart\AuthenticationBundle\Notification\ForgotPasswordNotification;
...
class AbstractSecurityController extends Controller
{
    ...
    public function __construct(TokenManagerInterface $tokenManager, NotifierInterface $notifier)
    {
    ...
    public function forgotPassword(Request $request)
    {
        ...
        try {
            ...
            if ($user instanceof SmartUserInterface) {
                ...
                $this->notifier->send($this->getForgotPasswordNotification([
    ...
    /**
     * This provide a default notification for the forgot password notification via email
     *
     * @param array<mixed> $parameters
     *
     * @return ForgotPasswordNotification
     */
    protected function getForgotPasswordNotification(array $parameters)
    {
        return new ForgotPasswordNotification($parameters);
    }
